...
const BaseForm = (props: BaseFormProps) => {
  return (
    <div className='flex absolute top-0 right-0 z-50 w-full justify-end min-h-[100svh]'>
      <Image
        src='/assets/cat.webp'
        className='hidden sm:block fixed top-0 drop-shadow-2xl p-0 object-cover w-1/2 left-0 h-full -z-10 brightness-75'
        alt='Logo'
        priority={true}
        placeholder='blur'
        ...
        height={1080}
      />
      <Card className='w-full sm:w-1/2 flex lg:divide-x-2 rounded-none'>
          ...
          <CardFooter>
            <Link
              className={cn(
                ...
                'p-0 h-auto whitespace-pre-wrap'
              )}
